...
with st.sidebar.expander("🎭 3. MBTI 心理类型"):
    mbti = st.selectbox("请选择 MBTI 人格：", ["INTJ", "INTP", "ENTJ", "ENTP", "INFJ", "INFP", "ENFJ", "ENFP", "ISTJ", "ISFJ", "ESTJ", "ESFJ", "ISTP", "ISFP", "ESTP", "ESFP"])

# 维度四：霍兰德
with st.sidebar.expander("🧬 4. 霍兰德职业兴趣 (RIASEC)"):
    holland = st.multiselect("请选择 2-3 个核心职业兴趣：", ["R (实用型 - 机器/操作)", "I (研究型 - 科学/思考)", "A (艺术型 - 设计/创造)", "S (社会型 - 助人/教育)", "E (企业型 - 领导/统筹)", "C (常规型 - 数据/规则)"])
...
if st.button("🚀 启动大模型临床解析", type="primary"):
    ...
    with col1:
        ...
        st.write("⚠️ **生理干预预警**：检测到生理/情绪通道分离。在备考期需强制设定物理闹钟提醒进食/饮水，防止生理性低血糖引发的情绪崩溃。")
    with col2:
